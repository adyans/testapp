 ...
 */
    ...
    function display($resource_name, $cache_id = null, $compile_id = null)
    {
		...
		//if(isset($arsfields))
		//	$this->assign('arsfields',$arsfields);
			
		$this->assign('template_dir',$this->template_dir);
			
			/*
		if(isset($_COOKIE['gp_themes']) && strstr($_SERVER["REQUEST_URI"],"geoportal")) {
			if($_COOKIE['gp_themes']=="white")
				$this->template_dir	.= "/default_white";
			else
				$this->template_dir	.= "/default_black";
		} elseif(strstr($_SERVER["REQUEST_URI"],"geoportal")) {
			$this->template_dir	.= "/default_black";
		}
		*/
		
		$lrid = rand(1,2);
		$this->assign('lrid',$lrid);
    

//var_dump($_SERVER["REQUEST_URI"]);
//var_dump(strstr($_SERVER["REQUEST_URI"],"geoportal"));
