<?php /* Smarty version 2.6.10, created on 2012-10-15 10:15:31
         compiled from news.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substr', 'news.htm', 33, false),)), $this); ?>
...
<th scope="col" class="rounded-q1" width="10%">Title</th>
...
" class="menus">Del</a></div>	  
		...
		<td valign="top"><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['title']; ?>
</div></td>
		<td valign="top"><div align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['data'][$this->_sections['c']['index']]['content'])) ? $this->_run_mod_handler('substr', true, $_tmp, 0, 400) : substr($_tmp, 0, 400)); ?>
...</div></td>
	</tr>
<?php endfor; endif; ?>
</tbody>
