<?php /* Smarty version 2.6.10, created on 2011-11-08 11:14:06
         compiled from voteitem.htm */ ?>
...
$this->_sections['c']['loop'] = is_array($_loop=$this->_tpl_vars['votecat']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
        	<option value="<?php echo $this->_tpl_vars['votecat'][$this->_sections['c']['index']]['id']; ?>
" <?php if ($_GET['vid'] == $this->_tpl_vars['votecat'][$this->_sections['c']['index']]['id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['votecat'][$this->_sections['c']['index']]['name']; ?>
</option>
		<?php endfor; endif; ?>
		</select> <input value="Show" type="submit" />
		</form>
...
<th scope="col" class="rounded-q4">Category</th>
</tr>
</thead>
<tbody>
<?php unset($this->_sections['c']);
...
&amp;vid=<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['vid']; ?>
" class="menus">Edit</a> - <a href="?a=del&amp;gid=<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['id']; ?>
" class="menus">Del</a></div>	  
		</td>
		<td><div align="left"><img src="../photos/p<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['id']; ?>
.jpg" height=50><br /><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['name']; ?>
</div></td>
	</tr>
<?php endfor; endif; ?>
</tbody>
