<?php /* Smarty version 2.6.10, created on 2011-11-08 11:14:03
         compiled from votecat.htm */ ?>
...
<thead><tr>
<th scope="col" class="rounded-company" width="20%"><a href="?a=add&amp;gid=<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['id']; ?>
...
" class="menus">Del</a> - <a href="voteitem.php?vid=<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['id']; ?>
" class="menus">Nominasi</a></div>	  
		</td>
		<td><div align="left"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['name']; ?>
</div></td>
	</tr>
<?php endfor; endif; ?>
</tbody>
