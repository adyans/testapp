<?php /* Smarty version 2.6.10, created on 2011-11-03 15:49:39
         compiled from foto.htm */ ?>
...
?>
	<tr>
	    <td>
			<div align="center"><a href="?a=del&amp;gid=<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['id']; ?>
" class="menus">Del</a></div>	  
		</td>
		<td><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['judul']; ?>
</div></td>
		<td><div align="center"><img src="<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['description']; ?>
" height="100px" /></div></td>
	</tr>
<?php endfor; endif; ?>
</tbody>
