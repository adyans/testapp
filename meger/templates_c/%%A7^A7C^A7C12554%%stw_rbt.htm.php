<?php /* Smarty version 2.6.10, created on 2011-03-15 14:22:18
         compiled from stw_rbt.htm */ ?>
...
<thead><tr>
<th scope="col" class="rounded-company"><a href="?a=add" class="menus">Add</a></th>
<th scope="col" class="rounded-q1">Judul</th>
<th scope="col" class="rounded-q1">Desc</th>
<th scope="col" class="rounded-q1">Image</th>
<th scope="col" class="rounded-q1">Action</th>
<th scope="col" class="rounded-q1">Preview</th>
...
');" class="menus">Del</a></div>	  
		...
		<td><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['desc']; ?>
</div></td>
		<td><div align="center"><img src="../<?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['image']; ?>
" /></div></td>
		<td><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['action']; ?>
</div></td>
		<td><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['preview']; ?>
</div></td>
		<td><div align="center"><?php echo $this->_tpl_vars['data'][$this->_sections['c']['index']]['detail']; ?>
</div></td>
	</tr>
<?php endfor; endif; ?>
</tbody>
