...
function action_post_edit(& $post) {
	...
	$id = $gid;
	@unlink("../uploads/images/store-".$id.".jpg");
	move_uploaded_file($_FILES['f_image']['tmp_name'],"../uploads/images/store-".$id.".jpg");
	$field['image'] = "uploads/images/store-".$id.".jpg";
