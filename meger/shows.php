...
function action_post_edit(& $post) {
	...
	$field['oleh'] = $_SESSION['uname'];
	//$field['tgl'] = date("Y-m-d H:i:s");
	$field['tgl'] = $post['tglYear']."-".$post['tglMonth']."-".$post['tglDay'];
...
function action_default(& $get, & $post) {
	...
	$smarty = new SmartyTable("$mname.php?".$query, $get,$param,"4 DESC");
...
$tname = "shows";
$jname = "Shows";
$sfields = "id,judul,description,tgl";
